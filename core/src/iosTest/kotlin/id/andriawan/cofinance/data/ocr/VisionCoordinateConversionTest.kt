...
class VisionCoordinateConversionTest {
    ...
    fun `keeps top above bottom for every box`() {
        ...
        // The box spans Y 0.3..0.5 measured up from the bottom, so its centre sits 0.4 above the
        // bottom edge — and therefore 0.6 below the top one. The centre flips with everything else.
        assertEquals(0.6f, rect.centerY, absoluteTolerance = 1e-5f)
    }
}
