...
import cofinance.composeapp.generated.resources.ic_receiver_account
import cofinance.composeapp.generated.resources.ic_sender_account
import cofinance.composeapp.generated.resources.label_beneficiary_account
import cofinance.composeapp.generated.resources.label_dates
import cofinance.composeapp.generated.resources.label_sender_account
...
fun TransferSection(
    ...
    Column(
        ...
        AddNewSection(
            ...
            label = stringResource(Res.string.label_sender_account),
            ...
            startIcon = {
                Icon(
                    painter = painterResource(Res.drawable.ic_sender_account),
        ...
        AddNewSection(
            modifier = Modifier.padding(horizontal = Dimensions.SIZE_16),
            label = stringResource(Res.string.label_beneficiary_account),
            value = uiState.receiverAccount?.let { "${it.name} (${NumberHelper.formatRupiah(it.balance)})" }.orEmpty(),
            onSectionClicked = {
            ...
            startIcon = {
                Icon(
                    painter = painterResource(Res.drawable.ic_receiver_account),
                    contentDescription = null,
                    tint = MaterialTheme.colorScheme.primary
                )
            },
