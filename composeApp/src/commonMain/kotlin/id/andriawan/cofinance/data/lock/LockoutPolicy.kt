...
object LockoutPolicy {
    ...
    fun delayBeforeNextAttempt(consecutiveFailures: Int): Duration {
        ...
        val doublings = (consecutiveFailures - FREE_ATTEMPTS).coerceAtMost(MAXIMUM_DOUBLINGS)
        val delay = FIRST_DELAY * (1 shl doublings)
     ...
     */
    private const val MAXIMUM_DOUBLINGS = 4
}
